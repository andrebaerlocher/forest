 ...
 */
export function getForestThemeColors(hue = 282, darkMode = false): ForestThemeColors {
 ...
 */
export function getForestMermaidTheme(options: MermaidThemeOptions = {}) {
  const {
    hue = 282,
    darkMode = false,
    fontFamily = '"Illinois Mono", "Lexend", ui-monospace, monospace',
    fontSize = "13px",
  } = options;
 ...
 */
export function getForestD2Theme(options: D2ThemeOptions = {}) {
