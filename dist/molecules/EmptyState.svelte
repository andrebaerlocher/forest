...
<style>
  .empty-state {
    ...
    text-align: center;
    padding: 48px 24px;
    /* min() rather than a bare 320px so a container narrower than 320
       (e.g. a 360px viewport with its own padding) never overflows it. */
  ...
  /* Gated: a stuck hover on touch would leave the CTA looking permanently
     lit with no way to release it. */
  @media (hover: hover) {
    .action-btn:hover {
