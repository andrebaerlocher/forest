...
<style>
  .dropdown-menu {
    ...
    /* anchored.ts clamps position to an 8px viewport margin but caps
       nothing about width — without a ceiling here a long menu item can
       push the menu past a 360px viewport regardless of where it's
       anchored. min()/max() mirror that same 8px margin on both ends. */
