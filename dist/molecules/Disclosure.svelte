...
<style>
  ...
  /* Stacked among other disclosures/headings in the reading column, so
     .hit-44 (an isolated-control tool) would overlap neighbours — grow
     the real row instead, as Accordion's trigger does. */
